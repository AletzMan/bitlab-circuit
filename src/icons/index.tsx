...
export function BJTNPNIcon(props: SVGProps<SVGSVGElement>) {
    return (
        <svg {...props} height="33px" width="33px" fill="currentColor" viewBox="144 144 512 512"  >
            <path strokeWidth={STROKE_WIDTH} stroke="currentColor" d="m400 557.69c41.312 0 79.098-16.121 107.31-42.32l-0.003906 111.34h12.594l0.003906-124.44c23.68-27.711 37.785-62.977 37.785-102.27s-14.105-74.562-37.785-102.27v-124.44h-12.594v111.34c-28.215-26.199-65.496-42.32-107.31-42.32-84.641 0-154.16 67.008-157.19 151.14l-69.527-0.003906v12.594h69.527c3.0195 84.137 72.547 151.65 157.19 151.65zm110.84-250.9c21.16 25.191 34.258 57.938 34.258 93.203 0 37.281-14.105 71.039-37.281 96.73l-53.402-35.266-4.0312 11.59-82.121-27.207v-91.691zm-110.84-51.387c39.297 0 75.066 15.617 101.27 41.312l-133 44.336-0.003907-41.816h-12.594v94.715h-100.76c3.5273-77.082 67.508-138.55 145.1-138.55zm-43.832 151.14v94.215h12.594v-41.816l78.09 26.199-4.0312 11.586 61.465 3.5273c-26.199 27.711-63.48 44.84-104.29 44.84-77.586 0-141.57-61.465-144.59-138.55z"></path>
        </svg>
    );
}
...
export function BJTPNPIcon(props: SVGProps<SVGSVGElement>) {
    return (
        <svg {...props} height="33px" width="33px" fill="currentColor" viewBox="144 144 512 512" >
            <path strokeWidth={STROKE_WIDTH} stroke="currentColor" d="m400 557.69c41.312 0 79.098-16.121 107.31-42.32l-0.003906 111.34h12.594l0.003906-124.44c23.68-27.711 37.785-62.977 37.785-102.27s-14.105-74.562-37.785-102.27v-124.44h-12.594v111.34c-28.215-26.199-65.496-42.32-107.31-42.32-84.641 0-154.16 67.008-157.19 151.14l-69.527-0.003906v12.594h69.527c3.0195 84.137 72.547 151.65 157.19 151.65zm110.84-250.9c21.16 25.191 34.258 57.938 34.258 93.203s-13.098 68.016-34.258 93.203l-142.07-47.359v-96.727l64.488-4.0312-4.0312-11.586zm-110.84-51.387c39.297 0 75.066 15.617 101.27 41.312l-76.074 25.191-4.0312-11.586-52.898 34.762-0.003907-45.848h-12.594v94.715h-100.76c3.5273-77.082 67.508-138.55 145.1-138.55zm-43.832 151.14v94.215h12.594v-41.816l133 44.336c-26.199 25.695-61.969 41.312-101.27 41.312-77.586 0-141.57-61.465-144.59-138.55l100.26-0.003906z"></path>
        </svg>
    );
}
