...
export function JFETPIcon(props: SVGProps<SVGSVGElement>) {
    return (
        <svg {...props} height="33px" width="33px" fill="currentColor" viewBox="144 144 512 512" >
            <path strokeWidth={STROKE_WIDTH} stroke="currentColor" d="m400 557.69c10.578 0 21.16-1.0078 31.738-3.0234v72.043h12.594v-75.57c65.496-19.145 113.36-79.602 113.36-151.14 0-71.539-47.863-132-113.36-151.14v-75.566h-12.594v72.547c-10.078-2.0156-20.656-3.0234-31.738-3.0234-86.656 0-157.69 70.535-157.69 157.69 0 15.113 2.0156 30.23 6.5508 44.336h-75.574v12.594h80.105c22.672 57.941 79.602 100.26 146.61 100.26zm31.738-16.121c-10.078 2.0156-20.656 3.5273-31.738 3.5273-60.961 0-113.36-38.289-134.52-91.691l57.938 15.617v-12.09h32.242v43.828h12.594v-44.336h62.977v85.145zm12.594-185.4v-94.215c58.441 18.641 100.76 73.555 100.76 138.04 0 64.488-42.32 119.4-100.76 138.04v-93.707h-75.57v-88.164zm-44.332-100.76c10.578 0 21.16 1.0078 31.738 3.5273v84.641l-62.977-0.003907v-44.332h-12.594v145.1h-32.242v-12.09l-59.953 16.121c-5.543-15.113-8.0625-31.234-8.0625-48.367-0.50391-80.105 63.984-144.59 144.09-144.59z"></path>
        </svg>
    );
}
...
export function JFETNIcon(props: SVGProps<SVGSVGElement>) {
    return (
        <svg {...props} height="33px" width="33px" fill="currentColor" viewBox="144 144 512 512"  >
            <path strokeWidth={STROKE_WIDTH} stroke="currentColor" d="m400 557.69c10.578 0 21.16-1.0078 31.738-3.0234v72.043h12.594v-75.57c65.496-19.145 113.36-79.602 113.36-151.14 0-71.539-47.863-132-113.36-151.14v-75.566h-12.594v72.547c-10.078-2.0156-20.656-3.0234-31.738-3.0234-86.656 0-157.69 70.535-157.69 157.69 0 15.113 2.0156 30.23 6.5508 44.336h-75.574v12.594h80.105c22.672 57.941 79.602 100.26 146.61 100.26zm31.738-16.121c-10.078 2.0156-20.656 3.5273-31.738 3.5273-59.953 0-111.34-36.273-133.51-88.168h27.207v12.09l61.969-16.625-0.003907 48.367h12.594v-44.336h62.977v85.145zm12.594-185.4v-94.215c58.441 18.641 100.76 73.555 100.76 138.04 0 64.488-42.32 119.4-100.76 138.04v-93.707h-75.57v-88.164zm-44.332-100.76c10.578 0 21.16 1.0078 31.738 3.5273v84.641l-62.977-0.003907v-44.332h-12.594v149.63l-61.969-16.625v12.09h-31.738c-4.5352-14.105-7.0547-28.719-7.0547-44.336 0-80.105 64.488-144.59 144.59-144.59z"></path>
        </svg>
    );
}
...
export function NChainEnhMOSFETIcon(props: SVGProps<SVGSVGElement>) {
    return (
        <svg {...props} height="33px" width="33px" fill="currentColor" viewBox="144 144 512 512"  >
            <path strokeWidth={STROKE_WIDTH} stroke="currentColor" d="m400 557.69c10.578 0 21.16-1.0078 31.738-3.0234v72.043h12.594v-75.57c65.496-19.145 113.36-79.602 113.36-151.14 0-71.539-47.863-132-113.36-151.14v-75.566h-12.594v72.547c-10.078-2.0156-20.656-3.0234-31.738-3.0234-86.656 0-157.69 70.535-157.69 157.69 0 15.113 2.0156 30.23 6.5508 44.336h-75.574v12.594h80.105c22.672 57.941 79.602 100.26 146.61 100.26zm0-302.29c10.578 0 21.16 1.0078 31.738 3.5273v59.449h-62.977v-19.145h-12.594v50.383h12.594v-19.145h75.57v-68.523c58.441 18.641 100.76 73.555 100.76 138.04 0 64.488-42.32 119.4-100.76 138.04v-144.59h-37.281v-31.738l-32.242 32.242h-6.0469v-19.145h-12.594v50.383h12.594v-19.145l6.0469-0.003906 31.738 31.738v-31.738h24.688v62.977h-62.473v-18.641h-12.594v50.383h12.594v-19.145h62.977v59.449c-10.078 2.0156-20.656 3.5273-31.738 3.5273-59.953 0-111.34-36.273-133.51-88.168h70.535l-0.003906-112.86h-12.598v100.76h-62.473c-4.5352-14.105-7.0547-28.719-7.0547-44.336 0.50781-80.102 64.996-144.59 145.1-144.59z"></path>
        </svg>
    );
}
...
export function PChainEnhMOSFETIcon(props: SVGProps<SVGSVGElement>) {
    return (
        <svg {...props} height="33px" width="33px" fill="currentColor" viewBox="144 144 512 512" >
            <path strokeWidth={STROKE_WIDTH} stroke="currentColor" d="m400 557.69c10.578 0 21.16-1.0078 31.738-3.0234v72.043h12.594v-75.57c65.496-19.145 113.36-79.602 113.36-151.14 0-71.539-47.863-132-113.36-151.14v-75.566h-12.594v72.547c-10.078-2.0156-20.656-3.0234-31.738-3.0234-86.656 0-157.69 70.535-157.69 157.69 0 15.113 2.0156 30.23 6.5508 44.336h-75.574v12.594h80.105c22.672 57.941 79.602 100.26 146.61 100.26zm0-302.29c10.578 0 21.16 1.0078 31.738 3.5273v59.449h-62.977v-19.145h-12.594v50.383h12.594v-19.145h75.57v-68.523c58.441 18.641 100.76 73.555 100.76 138.04 0 64.488-42.32 119.4-100.76 138.04v-144.59h-19.145l-31.738-31.738v31.738h-24.688v-18.641h-12.594v50.383h12.594v-19.145h24.688v31.738l31.738-31.738h6.0469v62.977l-62.473-0.003907v-18.641h-12.594v50.383h12.594v-19.145h62.977v59.449c-10.078 2.0156-20.656 3.5273-31.738 3.5273-59.953 0-111.34-36.273-133.51-88.168h70.535l-0.003906-112.86h-12.598v100.76h-62.473c-4.5352-14.105-7.0547-28.719-7.0547-44.336 0.50781-80.102 64.996-144.59 145.1-144.59z"></path>
        </svg>
    );
}
...
export function NChainDepMOSFETIcon(props: SVGProps<SVGSVGElement>) {
    return (
        <svg {...props} height="33px" width="33px" fill="currentColor" viewBox="144 144 512 512"  >
            <path strokeWidth={STROKE_WIDTH} stroke="currentColor" d="m444.33 248.86v-75.57h-12.594v72.547c-10.078-2.0156-20.656-3.0234-31.738-3.0234-86.656 0-157.69 70.535-157.69 157.69 0 15.113 2.0156 30.23 6.5508 44.336h-75.574v12.594h80.105c22.672 58.945 80.105 100.76 146.61 100.76 10.578 0 21.16-1.0078 31.738-3.0234v71.543h12.594v-75.57c65.496-19.145 113.36-79.602 113.36-151.14 0.003906-71.539-48.363-132-113.36-151.14zm-12.594 292.71c-10.078 2.0156-20.656 3.5273-31.738 3.5273-59.953 0-111.34-36.273-133.51-88.168h70.535l-0.003906-113.36h-12.598v100.76h-62.473c-4.5352-14.105-7.0547-28.719-7.0547-44.336 0-80.105 64.992-145.1 145.1-145.1 10.578 0 21.16 1.0078 31.738 3.5273v59.449l-62.973 0.003906v-18.641h-12.594v201.52h12.594v-19.145h62.977zm0-72.047h-62.977v-62.977h6.0469l31.738 31.738v-31.738h24.688v62.977zm12.594 68.52v-144.59h-37.281v-31.738l-32.242 32.242h-6.0469v-62.977h75.57v-69.023c58.441 18.641 100.76 73.555 100.76 138.04 0 64.488-42.82 119.41-100.76 138.05z"></path>
        </svg>
    );
}
...
export function PChainDepMOSFETIcon(props: SVGProps<SVGSVGElement>) {
    return (
        <svg {...props} height="33px" width="33px" fill="currentColor" viewBox="144 144 512 512" >
            <path strokeWidth={STROKE_WIDTH} stroke="currentColor" d="m444.33 248.86v-75.57h-12.594v72.547c-10.078-2.0156-20.656-3.0234-31.738-3.0234-86.656 0-157.69 70.535-157.69 157.69 0 15.113 2.0156 30.23 6.5508 44.336h-75.574v12.594h80.105c22.672 58.945 80.105 100.76 146.61 100.76 10.578 0 21.16-1.0078 31.738-3.0234v71.543h12.594v-75.57c65.496-19.145 113.36-79.602 113.36-151.14 0.003906-71.539-48.363-132-113.36-151.14zm-12.594 292.71c-10.078 2.0156-20.656 3.5273-31.738 3.5273-59.953 0-111.34-36.273-133.51-88.168h70.535l-0.003906-113.36h-12.598v100.76h-62.473c-4.5352-14.105-7.0547-28.719-7.0547-44.336 0-80.105 64.992-145.1 145.1-145.1 10.578 0 21.16 1.0078 31.738 3.5273v59.449l-62.973 0.003906v-18.641h-12.594v201.52h12.594v-19.145h62.977zm0-72.047h-62.977v-62.977h24.688v31.738l31.738-31.738h6.0469v62.977zm12.594 68.52v-144.59h-19.145l-31.738-31.738v31.738h-24.688v-62.473h75.57v-69.023c58.441 18.641 100.76 73.555 100.76 138.04 0 64.488-42.82 119.41-100.76 138.05z"></path>
        </svg>
    );
}
