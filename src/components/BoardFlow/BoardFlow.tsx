...
const initialNodes: AnalogNode[] = [
    {
        ...
        data: { name: 'Resistor', type: ComponentType.Resistor, value: 1, rotation: 0, flip: { x: 1, y: 1 }, collapsed: ComponentCollapsed.Undefined, isLock: false, unit: UnitsType.Ohm, prefix: 'KΩ', has_properties: true, reference: "R1", isValueVisible: true, isReferenceVisible: true, connectedHandles: [false, false], size: 'small' },
        position: { x: 100, y: 170 },
    },
    {
        id: uuid(),
        type: 'analogComponent',
        data: { name: 'Capacitor', type: ComponentType.Capacitor, value: 4.7, rotation: 0, flip: { x: 1, y: 1 }, collapsed: ComponentCollapsed.Undefined, isLock: false, unit: UnitsType.Capacitance, prefix: 'µF', has_properties: true, reference: "C1", isValueVisible: true, isReferenceVisible: true, connectedHandles: [false, false], size: 'small' },
        position: { x: 240, y: 170 },
    },
    {
        id: uuid(),
        type: 'nodeComponent',
        data: { name: 'Node', type: ComponentType.Node, value: 0, rotation: 0, flip: { x: 1, y: 1 }, collapsed: ComponentCollapsed.Undefined, isLock: false, unit: UnitsType.Undefined, prefix: '', has_properties: false, reference: "N1", isValueVisible: false, isReferenceVisible: false, connectedHandles: [false, false, false, false], color: "var(--foreground-color)", size: 'small' },
        position: { x: 90, y: 90 },
    },
];
    ...
    const handleOnDrop = (e: DragEvent<HTMLDivElement>) => {
        ...
        if (type as ComponentType && Object.keys(ComponentsMap).includes(type)) {
            ...
            node = {
                ...
                type: typeComponent,
                position,
                data: { name, type, value, isLock: false, rotation: 0, flip: { x: 1, y: 1 }, collapsed: ComponentCollapsed.Undefined, unit, prefix, has_properties, reference, isReferenceVisible, isValueVisible, connectedHandles, color, size },
                parentId: board?.id,
                style
            };
        }
