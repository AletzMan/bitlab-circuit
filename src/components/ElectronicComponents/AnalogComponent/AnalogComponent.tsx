...
export function AnalogComponent({ data: { type, value, rotation, flip, collapsed, isLock, prefix, reference, isReferenceVisible, isValueVisible, connectedHandles, size, color }, selected, id, parentId }: NodeProps<AnalogNode>) {
