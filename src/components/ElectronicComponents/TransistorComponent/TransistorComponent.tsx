...
export function TransistorComponent({ data: { type, value, rotation, flip, collapsed, isLock, prefix, designator, isReferenceVisible, isValueVisible, connectedHandles, size }, selected, id, parentId }: NodeProps<AnalogNode>) {
