...
export function Battery({ data: { type, rotation, flip, collapsed, isLock, designator, isDesignatorVisible, connectedHandles, size, isValueVisible, prefix, value }, selected, id, parentId }: NodeProps<AnalogNode>) {
