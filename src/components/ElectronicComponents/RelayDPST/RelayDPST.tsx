...
export function RelayDPST({ data: { type, rotation, flip, collapsed, isLock, designator, isReferenceVisible, connectedHandles, size, state }, selected, id, parentId }: NodeProps<AnalogNode>) {
