...
import { AnalogNode, ComponentCollapsed, ITerminalSetting } from "@/types";
...
export function RelayDPDT({ data: { type, rotation, flip, collapsed, isLock, designator, isDesignatorVisible, connectedHandles, size, state }, selected, id, parentId }: NodeProps<AnalogNode>) {
    ...
    const terminalSettings: ITerminalSetting = useMemo(() => {
        ...
        switch (rotation) {
            case 0: {
                position = [Position.Left, Position.Right, Position.Right, Position.Left, Position.Right, Position.Right, Position.Bottom, Position.Bottom];
                adjustment = [{ top: `calc(50% - 30px)` }, { top: `calc(50% - 40px)` }, { top: `calc(50% - 20px)` }, { top: `calc(50% + 10px)` }, { top: `calc(50% + 20px)` }, { top: `50%` }, { left: `calc(50% - 20px )` }, { left: `calc(50% + 20px )` }];
                if (flip.x === -1 && flip.y === 1) {
                    position = [Position.Right, Position.Left, Position.Left, Position.Right, Position.Left, Position.Left, Position.Bottom, Position.Bottom];
                    adjustment = [{ top: `calc(50% - 30px)` }, { top: `calc(50% - 40px)` }, { top: `calc(50% - 20px)` }, { top: `calc(50% + 10px)` }, { top: `calc(50% + 20px)` }, { top: `50%` }, { left: `calc(50% + 20px )` }, { left: `calc(50% - 20px )` }];
                } else if (flip.y === -1 && flip.x === 1) {
                    position = [Position.Left, Position.Right, Position.Right, Position.Left, Position.Right, Position.Right, Position.Top, Position.Top];
                    adjustment = [{ top: `calc(50% + 30px)` }, { top: `calc(50% + 40px)` }, { top: `calc(50% + 20px)` }, { top: `calc(50% - 10px)` }, { top: `calc(50% - 20px)` }, { top: `50%` }, { left: `calc(50% - 20px )` }, { left: `calc(50% + 20px )` }];
                } else if (flip.y === -1 && flip.x === -1) {
                    position = [Position.Right, Position.Left, Position.Left, Position.Right, Position.Left, Position.Left];
                    adjustment = [{ top: `calc(50% + 30px)` }, { top: `calc(50% + 40px)` }, { top: `calc(50% + 20px)` }, { top: `calc(50% - 10px)` }, { top: `calc(50% - 20px)` }, { top: `50%` }, { left: `calc(50% + 20px )` }, { left: `calc(50% - 20px )` }];
                }
                return { position: position, adjustment };
            }
            case 90: {
                position = [Position.Top, Position.Bottom, Position.Bottom, Position.Top, Position.Bottom, Position.Bottom, Position.Left, Position.Left];
                adjustment = [{ left: `calc(50% + 30px)` }, { left: `calc(50% + 40px)` }, { left: `calc(50% + 20px)` }, { left: `calc(50% - 10px)` }, { left: `calc(50% - 20px)` }, { left: `50%` }, { top: `calc(50% - 20px)` }, { top: `calc(50% + 20px)` }];
                if (flip.x === -1 && flip.y === 1) {
                    position = [Position.Top, Position.Bottom, Position.Bottom, Position.Top, Position.Bottom, Position.Bottom, Position.Right, Position.Right];
                    adjustment = [{ left: `calc(50% - 30px)` }, { left: `calc(50% - 40px)` }, { left: `calc(50% - 20px)` }, { left: `calc(50% + 10px)` }, { left: `calc(50% + 20px)` }, { left: `50%` }, { top: `calc(50% - 20px)` }, { top: `calc(50% + 20px)` }];
                } else if (flip.y === -1 && flip.x === 1) {
                    position = [Position.Bottom, Position.Top, Position.Top, Position.Bottom, Position.Top, Position.Top, Position.Left, Position.Left];
                    adjustment = [{ left: `calc(50% + 30px)` }, { left: `calc(50% + 40px)` }, { left: `calc(50% + 20px)` }, { left: `calc(50% - 10px)` }, { left: `calc(50% - 20px)` }, { left: `50%` }, { top: `calc(50% + 20px)` }, { top: `calc(50% - 20px)` }];
                } else if (flip.y === -1 && flip.x === -1) {
                    position = [Position.Bottom, Position.Top, Position.Top, Position.Bottom, Position.Top, Position.Top, Position.Right, Position.Right];
                    adjustment = [{ left: `calc(50% - 30px)` }, { left: `calc(50% - 40px)` }, { left: `calc(50% - 20px)` }, { left: `calc(50% + 10px)` }, { left: `calc(50% + 20px)` }, { left: `50%` }, { top: `calc(50% + 20px)` }, { top: `calc(50% - 20px)` }];
                }
                return { position: position, adjustment };
            }
            case 180: {
                position = [Position.Right, Position.Left, Position.Left, Position.Right, Position.Left, Position.Left, Position.Top, Position.Top];
                adjustment = [{ top: `calc(50% + 30px)` }, { top: `calc(50% + 40px)` }, { top: `calc(50% + 20px)` }, { top: `calc(50% - 10px)` }, { top: `calc(50% - 20px)` }, { top: `50%` }, { left: `calc(50% + 20px )` }, { left: `calc(50% - 20px )` }];
                if (flip.x === -1 && flip.y === 1) {
                    position = [Position.Left, Position.Right, Position.Right, Position.Left, Position.Right, Position.Right, Position.Top, Position.Top];
                    adjustment = [{ top: `calc(50% + 30px)` }, { top: `calc(50% + 40px)` }, { top: `calc(50% + 20px)` }, { top: `calc(50% - 10px)` }, { top: `calc(50% - 20px)` }, { top: `50%` }, { left: `calc(50% - 20px )` }, { left: `calc(50% + 20px )` }];
    ...
    return (
        <div className={`${styles.box}  ${isAdditionValid && styles.box_valid} ${isAdditionInvalid && styles.box_invalid} ${rotation === 90 && styles.box_90} ${rotation === 270 && styles.box_270}`}>
            ...
            <Terminal type="source" position={terminalSettings.position[6]} id="7" isConnectable={!isConnected[6]} style={terminalSettings.adjustment[6]} />
            <Terminal type="source" position={terminalSettings.position[7]} id="8" isConnectable={!isConnected[7]} style={terminalSettings.adjustment[7]} />
