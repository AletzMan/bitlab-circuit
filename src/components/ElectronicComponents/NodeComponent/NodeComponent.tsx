...
export function NodeComponent({
	data: { type, collapsed, isLock, designator, isDesignatorVisible, connectedHandles, color },
	selected,
	id,
	parentId,
	...
	return (
		...
		>
			...
			<svg viewBox="0 0 600 600" className={styles.paths}>
				<path
					d="M300,300 L300,22"
					className={`${styles.path} ${styles.path_top} ${
						isConnected[0] && styles.path_top_connected
					}`}
					style={
						{
							"--wire-color":
								(color === "#000000" || color === "rgb(0,0,0)") && currentTheme === "dark"
									? "#FFFFFF"
									: (color?.toLowerCase() === "#ffffff" || color === "rgb(255,255,255)") &&
									  currentTheme === "light"
									? "#000000"
									: color,
						} as CSSProperties
				...
				<path
					d="M300,300 L577,300"
					className={`${styles.path} ${styles.path_right} ${
						isConnected[1] && styles.path_right_connected
					}`}
					style={
						{
							"--wire-color":
				...
				<path
					d="M300,300 L300,577"
					className={`${styles.path} ${styles.path_bottom} ${
						isConnected[2] && styles.path_bottom_connected
					}`}
					style={
						{
							"--wire-color":
				...
				<path
					d="M300,300 L23,300"
					className={`${styles.path} ${styles.path_left} ${
						isConnected[3] && styles.path_left_connected
					}`}
					style={
						{
							"--wire-color":
